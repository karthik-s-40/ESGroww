...
function EditProfileModal({ open, data, onClose, onSaved }: {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-2xl rounded-3xl border shadow-2xl flex flex-col mx-3 sm:mx-0"
        style={{ background: BRAND.bg, borderColor: BRAND.border, maxHeight: "88vh" }}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-4 sm:px-7 sm:py-5 border-b shrink-0" style={{ borderColor: BRAND.border }}>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 sm:px-7 sm:py-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {fields.map((field) => {
              ...
              return (
                <div key={field.key} className={field.span === 2 ? "sm:col-span-2" : "sm:col-span-1"}>
        ...
        {/* Footer */}
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-4 py-4 sm:px-7 sm:py-5 border-t shrink-0" style={{ borderColor: BRAND.border }}>
